...
char *weapons_list[16] = {
    "hk69", "lr", "spas12", "m4", "psg1", "mp5k", "ak103", "negev", "g36", "sr8", "ump45", "mac11", "p90", "frf1",
    "benelli", "fstod"
};
char *items[3] = {"silencer", "laser", "medkit"};
// Removed helmet & vest as now given always for a throwing knife kill.
...
qboolean wasKillNoscope(client_t *klr) {
    ...
    if (klr->lastUsercmd.buttons == 67585 || klr->lastUsercmd.buttons == 2081 || klr->lastUsercmd.buttons == 2049 || klr
        ->lastUsercmd.buttons == 67841 || klr->lastUsercmd.buttons == 2049 || klr->lastUsercmd.buttons == 2305) {
        noscope = qtrue;
    }
    return noscope;
}
...
void SV_OnMapExit(void) {
    if (mod_zombiemod->integer) {
        ...
        Cmd_ExecuteString(
            "bigtext \"^3The ^2Teams ^3have been ^5swapped\n\n\n^3Press ^1TAB ^3to view the ^5scoreboard\"");
    }
}
            ...
            if (Q_stricmp(killer, killed) != 0) {
                ...
                // Knife thrown
                    ...
                    SV_SendServerCommand(
                        klr, "cchat \"\" \"^6~^8> ^1Throwing Knife ^7kill ^1= ^6%s ^3and ^2Vest+Helmet\"",
                        SV_NameItem(item));
                ...
                // Desert Eagle
                    ...
                    char *weapon = weapons_list[random];
                    Cmd_ExecuteString(va("gw %s %s", killer, weapon));
                    SV_SendServerCommand(klr, "cchat \"\" \"^6~^8> ^2Desert Eagle ^7kill ^1= %s\"",
                                         SV_NameWeapon(weapon));
                }
                // Spas
                    ...
                    SV_SendServerCommand(klr, "cchat \"\" \"^6~^8> ^3Spas12 ^7kill ^1= %s ^4+%i\"",
                                         SV_NameWeapon(weapon), amo2);
                }
                // Benelli
                    ...
                    int amo2 = (rand() % 255) + 1;
                    Cmd_ExecuteString(va("gw %s %s +%i 0", killer, weapon, amo2));
                    SV_SendServerCommand(klr, "cchat \"\" \"^6~^8> ^3Benelli ^7kill ^1= %s ^4+%i\"",
                                         SV_NameWeapon(weapon), amo2);
                }
                // UMP45
                    ...
                    SV_SendServerCommand(klr, "cchat \"\" \"^6~^8> ^3UMP45 ^7kill ^1= %s ^4+30\"",
                                         SV_NameWeapon(weapon));
                }
                // MP5K
                    ...
                    SV_SendServerCommand(klr, "cchat \"\" \"^6~^8> ^3MP5K ^7kill ^1= %s ^4+15\"",
                                         SV_NameWeapon(weapon));
                }
                // LR
                ...
                // HK69
                    ...
                    if (operator == '-') {
                        SV_SendServerCommand(klr, "cchat \"\" \"^6~^8> ^1HK69 ^7kill ^1= ^7Random Health: ^1-%i\"",
                                             health2);
                    } else if (operator == '+') {
                        SV_SendServerCommand(klr, "cchat \"\" \"^6~^8> ^1HK69 ^7kill ^1= ^7Random Health: ^2+%i\"",
                                             health2);
                    }
                }
                // BLEED
                ...
                // NEGEV
                    ...
                    Cmd_ExecuteString(va("addhealth %s %c%i", killer, operator, health2));
                    if (operator == '-') {
                        SV_SendServerCommand(klr, "cchat \"\" \"^6~^8> ^4NEGEV ^7kill ^1= ^7Random Health: ^1-%i\"",
                                             health2);
                    } else if (operator == '+') {
                        SV_SendServerCommand(klr, "cchat \"\" \"^6~^8> ^4NEGEV ^7kill ^1= ^7Random Health: ^2+%i\"",
                                             health2);
                    }
                }
                // M4
                ...
                // CURB (GOOMBA)
                    ...
                    Cmd_ExecuteString(va("gi %i helmet", ps->clientNum));
                    SV_SendServerCommand(
                        klr, "cchat \"\" \"^6~^8> ^6Curb Stomp ^7kill ^1= ^5HK69/SPAS12/Smokes ^3and ^6all Items\"");
                    Cmd_ExecuteString(va(
                        "bigtext \"%s made a ^6Curb Stomp^7!!\n^3He won ^5HK69/SPAS12/Smokes ^3and ^6all Items\"",
                        klr->name));
                ...
                // MAC-11
                    ...
                    Cmd_ExecuteString(va("gw %s %s +30 0", killer, weapon));
                    SV_SendServerCommand(klr, "cchat \"\" \"^6~^8> ^3MAC-11 ^7kill ^1= %s ^4+30\"",
                                         SV_NameWeapon(weapon));
                }
                // P90
...
void parseClientSettings(client_t *client, char *message) {
    ...
    if (strcmp(Cmd_Argv(0), "!preference") == 0) {
        ...
        if (strcmp(data, "primary") == 0) {
            ...
            SV_SendServerCommand(
                client,
                "cchat \"\" \"^5[^3Arena^5] ^1Error: [Unknown preference] ^3See ^2!guns ^3for a list of preferences.\"");
        }
    } else if (strcmp(Cmd_Argv(0), "!set") == 0) {
        type = Cmd_Argv(1);
        data = Cmd_Argv(2);

        if (strcmp(type, "primary") != 0 && strcmp(type, "secondary") != 0 && strcmp(type, "pistol") != 0 &&
            strcmp(type, "sniper") != 0) {
            SV_SendServerCommand(
                client, "cchat \"\" \"^5[^3Arena^5] ^1Error: [Unknown Type] ^3See ^2!guns ^3for a list of types.\"");
            ...
            if (strcmp(data, "lr300") == 0) {
                ...
                SV_SendServerCommand(
                    client,
                    "cchat \"\" \"^5[^3Arena^5] ^1Error: [Unknown Weapon] ^3See ^2!guns ^3for exact weapon names.\"");
            }
...
void SV_onChat(char *playerid, char *playername, char *message) {
    ...
    if (mod_gunsmod->integer) {
        if (strcmp(message, "!kitlist") == 0) {
            ...
            SV_SendServerCommand(
                cl, "print  \"^3////////////////////////////////////////////////////////////////////////////\n\"");
            SV_SendServerCommand(
                cl, "print  \"^3//               ^1! BUYING A KIT WILL LOSE ALL YOUR WEAPONS !              ^3//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^3//-----------------------------------^3/------------------------------------^3//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7////////////////////////////////////////////////////////////////////////////\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//               Armor               ^7/             Attachments            ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//-----------------------------------^7/------------------------------------^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3Kevlar Vest                       ^7/  ^3Laser                             ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3Helmet                            ^7/  ^3Silencer                          ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7//           ^2Price:^6 1620 coins       ^7/  ^3Clips (-2x500 coins per weapon)   ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7//                                   ^7/      ^2Base Price:^6  900 coins        ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//........................................................................^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//               Rifles              ^7/               Snipers              ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//-----------------------------------^7/------------------------------------^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3M4                                ^7/  ^3SR8                               ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3LR300                             ^7/  ^3FRF1                              ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3AK103                             ^7/  ^3PSG1                              ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7//           ^2Price:^6 13545 coins      ^7/           ^2Price:^6 21600 coins       ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//........................................................................^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//            Secondaries            ^7/                                    ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//-----------------------------------^7/------------------------------------^7//\n\"");
            SV_SendServerCommand(
                cl,
            ...
            SV_SendServerCommand(
                cl,
                "print  \"^7//           ^2Price:^6 19575 coins      ^7/                                    ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//........................................................................^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//  ^5Usage:                                                                ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//  !kit <KIT SHORT/NAME>  for example: !kit armor / !kit ar              ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//                                      !kit attachments / !kit att       ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7////////////////////////////////////////////////////////////////////////////\n\"");
            ...
            SV_SendServerCommand(
                cl, "print  \"^7////////////////////////////////////////////////////////////////////////////\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//           Sniper Rifles           ^7/         Assault Rifles             ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//-----------------------------------^7/------------------------------------^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3sr8     ^2Price:^6 8000 coins         ^7/  ^3lr300    ^2Price:^6 5500 coins        ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3psg1    ^2Price:^6 8000 coins         ^7/  ^3g36      ^2Price:^6 6000 coins        ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3frf1    ^2Price:^6 8000 coins         ^7/  ^3ak103    ^2Price:^6 7000 coins        ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7//                                   ^7/  ^3M4       ^2Price:^6 2550 coins        ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//........................................................................^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//             SMG's                 ^7/              Shotguns              ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//-----------------------------------^7/------------------------------------^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3ump45   ^2Price:^6 3250 coins         ^7/  ^3spas12   ^2Price:^6 12000 coins       ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3mp5k    ^2Price:^6 3250 coins         ^7/  ^3benelli  ^2Price:^6 10000 coins       ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3p90     ^2Price:^6 3250 coins         ^7/                                    ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3mac11   ^2Price:^6 3250 coins         ^7/                                    ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//........................................................................^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//           Machine Guns            ^7/             Specials               ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//-----------------------------------^7/------------------------------------^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3negev      ^2Price:^6 4000 coins      ^7/  ^3fstod    ^2Price:^6  30000 coins      ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7//                                   ^7/  ^3hk69     ^2Price:^6  10000 coins      ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//........................................................................^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//             Abilites              ^7/             Equipment              ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//-----------------------------------^7/------------------------------------^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3!disarm    ^2Price:^6 500000  coins   ^7/  ^3Vest     ^2Price:^6 1000 coins        ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3!invisible ^2Price:^6 750000  coins   ^7/  ^3Helmet   ^2Price:^6  800 coins        ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3!ammo      ^2Price:^6  65000  coins   ^7/  ^3Silencer ^2Price:^6  500 coins        ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3!clips     ^2Price:^6  45000  coins   ^7/  ^3Laser    ^2Price:^6  500 coins        ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3!maptp     ^2Price:^6  50000  coins   ^7/  ^3NVG      ^2Price:^6 3000 coins        ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3!lowgrav   ^2Price:^6 1000000 coins   ^7/                                    ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3!slapall   ^2Price:^6 1000000 coins   ^7/                                    ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3!b health  ^2Price:^6  15000  coins   ^7/                                    ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3!laugh     ^2Price:^6  25000  coins   ^7/                                    ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3!teleport  ^2Price:^6 250000  coins   ^7/                                    ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3!freeze    ^2Price:^6 550000  coins   ^7/                                    ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3!nades     ^2Price:^6 500000  coins   ^7/                                    ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3!slick     ^2Price:^6 500000  coins   ^7/                                    ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3!crazy     ^2Price:^6 1000000 coins   ^7/                                    ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3!overclock ^2Price:^6 500000  coins   ^7/                                    ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3!airjumps  ^2Price:^6 1000000 coins   ^7/                                    ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7// ^3!superbots ^2Price:^6 1000000 coins   ^7/                                    ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7// ^3!vampire <amount> 1 minute = 10000 coins                               ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//........................................................................^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//  ^5Specials:                                                             ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//  !gamble <amount> (Gamble for a 50/50 chance to tripple your input!)   ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//  !particles (Will activate particles around you)^2Price:^610000000 coins^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7//  !buycolour <colour number> ^2Price: ^610000000 coins                      ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7//  colours: ^11^7=^1red ^22^7=^2green ^33^7=^3yellow ^44^7=^4blue ^55^7=^5cyan ^66^7=^6purple ^88^7=^8orange ^99^7=^9grey^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//  ^5Usage:                                                                ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//  !buy <WEAPON NAME>     for example: !buy sr8                          ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//  !buy <ITEM NAME>       for example: !buy vest                         ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//  ^5Autobuy:                                                              ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//  !buy <WEAPON NAME> ON  for example: !buy sr8 on                       ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//  !buy <ITEM NAME> ON    for example: !buy vest on                      ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//  ^5Abilites:                                                             ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//  !maptp (no !b required, simply use !<ability name>)                   ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//  !heal                                                                 ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7////////////////////////////////////////////////////////////////////////////\n\"");
    ...
    if (mod_1v1arena->integer) {
        if (strcmp(message, "!guns") == 0) {
            ...
            SV_SendServerCommand(
                cl,
                "print  \"^7//  ^2!set ^6<type> <weapon>                                                  ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7//  ^2!preference ^6<type>                                                    ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//                                                                        ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//  ^5Types:                                                                ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//  ^4primary / secondary / pistol / sniper / knife / gib                   ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//                                                                        ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//  ^5Weapons:                                                              ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7//  ^2Primary: ^4lr300, g36, ak103, m4, negev, hk69                           ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7//  ^2Secondary: ^4ump45, mac11, p90, mp5k, spas12, benelli                   ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7//  ^2Pistol: ^4beretta, deagle, colt, glock, magnum                          ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7//  ^2Sniper: ^4psg1, sr8, frf1                                               ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//                                                                        ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//                                                                        ^7//\n\"");
            ...
            SV_SendServerCommand(
                cl,
                "print  \"^7//  ^2!set ^6primary lr300                                                    ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7//  ^2!set ^6secondary ump45                                                  ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7//  ^2!set ^6pistol deagle                                                    ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7//  ^2!set ^6sniper sr8                                                       ^7//\n\"");
            SV_SendServerCommand(
                cl,
                "print  \"^7//  ^2!preference ^6primary                                                   ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7//                                                                        ^7//\n\"");
            SV_SendServerCommand(
                cl, "print  \"^7////////////////////////////////////////////////////////////////////////////\n\"");
    ...
    if (mod_gunsmod->integer || mod_levelsystem->integer) {
        ...
        if ((strcmp(message, "hi") == 0) || (strcmp(message, "hello") == 0) || (strcmp(message, "hallo") == 0) || (
                strcmp(message, "salut") == 0) || (strcmp(message, "hey") == 0) || (strcmp(message, "ciao") == 0)) {
        ...
        if ((strcmp(message, "hru") == 0) || (strcmp(message, "how you doin") == 0) || (
                strcmp(message, "how are you") == 0)) {
        ...
        if ((strcmp(message, "idiot") == 0) || (strcmp(message, "dumbass") == 0) || (
                strcmp(message, "you idiot") == 0)) {
        ...
        if ((strcmp(message, "np") == 0) || (strcmp(message, "no problem") == 0) || (
                strcmp(message, "no worries") == 0)) {
            Cmd_ExecuteString(va("exec sound_np.txt"));
            cl->lastsoundtime = time;
        }
        if ((strcmp(message, "status") == 0) || (strcmp(message, "whats up") == 0) || (strcmp(message, "status?") == 0)
            || (strcmp(message, "sup") == 0)) {
...
void EV_ClientUserInfoChanged(int cnum) {
    ...
    if (mod_1v1arena->integer) {
        ...
        team = *(int *) ((void *) ps + gclientOffsets[getVersion()][OFFSET_TEAM]);
        if (team == 3) {
            Cmd_ExecuteString(va("location %i \"^7[^3Arena ^5SPEC^7][^3Skill ^5%i^7]\" 0 1", client->playernum,
                                 client->skill));
        } else if (sv.Arenas[client->arena].population == 1) {
            Cmd_ExecuteString(va("location %i \"^7[^3Arena ^5%i^7][^3Skill ^5%i^7] ^5- ^3facing ^1no opponent\" 0 1",
                                 client->playernum, client->arena, client->skill));
        } else {
            client_t *cl2;
            ...
            Cmd_ExecuteString(va("location %i \"^7[^3Arena ^5%i^7][^3Skill ^5%i^7] ^5- ^3facing ^6%s\" 0 1",
                                 client->playernum, client->arena, client->skill, cl2->colourName));
        }
    }
    ...
    if (mod_levelsystem->integer) {
        ...
        //The ^1 at the end will affect the kills/deaths on the mini scoreboard
        ...
        // Shoot a location update for the new name
        Cmd_ExecuteString(va(
            "location %i \"%s ^3Level:^7[^2%i^7/^2999^7] ^4- ^3XP:^7[^2%i^7/^25000^7] ^4- ^3Spree: ^2%i\" 0 1",
            client->clientgamenum, client->name, client->level, client->experience, client->kills));
    }
...
void EV_ClientConnect(int cnum) {
    ...
    if (mod_1v1arena->integer) {
        ...
        if (!guid) {
            // return if theres no guid to use.
            return;
        }
        // open the data file
        ...
        if (len > 0) {
            // copy back the data
            sscanf(buffer, "%i,%i,%i,%i,%i,%i", &client->skill, &client->preference, &client->primary,
                   &client->secondary, &client->pistol, &client->sniper);
        }
...
void EV_ClientDisconnect(int cnum) {
    ...
    if (mod_1v1arena->integer) {
        ...
        Com_sprintf(buffer, sizeof(buffer), "%i,%i,%i,%i,%i,%i", client->skill, client->preference, client->primary,
                    client->secondary, client->pistol, client->sniper);
...
void EV_ClientKill(int cnum, int target) {
    ...
    if (mod_levelsystem->integer) {
        ...
        Cmd_ExecuteString(va(
            "location %i \"%s ^3Level:^7[^2%i^7/^2999^7] ^4- ^3XP:^7[^2%i^7/^25000^7] ^4- ^3Spree: ^2%i\" 0 1", cnum,
            kld->name, kld->level, kld->experience, kld->kills));

        if ((klr->experience + 200) >= 5000) {
            klr->experience = 0;
            klr->level = (klr->level + 1);
            Cmd_ExecuteString(va("bigtext \"%s ^3has just ^2Leveled UP! ^3Level:^7[^2%i^3/^5999^7]\"", klr->name,
                                 klr->level));
            ...
            Cmd_ExecuteString(va(
                "location %i \"%s ^3Level:^7[^2%i^7/^2999^7] ^4- ^3XP:^7[^2%i^7/^25000^7] ^4- ^3Spree: ^2%i\" 0 1",
                cnum, klr->name, klr->level, klr->experience, klr->kills));
        } else {
...
intptr_t SV_GameSystemCalls(intptr_t *args) {
    switch (args[0]) {
        ...
        case BOTLIB_AAS_ALTERNATIVE_ROUTE_GOAL:
            return botlib_export->aas.AAS_AlternativeRouteGoals(VMA(1), args[2], VMA(3), args[4], args[5], VMA(6),
                                                                args[7], args[8]);
        ...
        case BOTLIB_AAS_PREDICT_ROUTE:
            return botlib_export->aas.AAS_PredictRoute(VMA(1), args[2], VMA(3), args[4], args[5], args[6], args[7],
        ...
        case BOTLIB_AAS_PREDICT_CLIENT_MOVEMENT:
            return botlib_export->aas.AAS_PredictClientMovement(VMA(1), args[2], VMA(3), args[4], args[5],
                                                                VMA(6), VMA(7), args[8], args[9], VMF(10), args[11],
                                                                args[12], args[13]);
        ...
        case BOTLIB_AI_REPLY_CHAT:
            return botlib_export->ai.BotReplyChat(args[1], VMA(2), args[3], args[4], VMA(5), VMA(6), VMA(7), VMA(8),
